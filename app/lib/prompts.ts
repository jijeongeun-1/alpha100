...
▸ 패키지형
  ...
  창업도약패키지, 창도, 창도패 / 재도전성공패키지, 재도전

▸ 바우처형
  혁신바우처, 관광바우처, 제조바우처, 스마트서비스바우처,
  바우처 (단독으로 쓰인 경우 포함)
...
export function buildUserPrompt(params: {
  ...
  const { projectType, prevReportText, workFilesText, templateText, memo } = params
